# Distributions, Deployment, and Operations | EDC
Explains how to create distributions and design deployment architectures. This chapter also provides an overview of _Management Domains_ and system configuration.
...
Deployment Architectures and Operations[](#deployment-architectures-and-operations)
-----------------------------------------------------------------------------------
...
### Type 1: Single Management Domain[](#type-1-single-management-domain)
...
![](https://eclipse-edc.github.io/documentation/for-adopters/distributions-deployment-operations/single-instance.svg)

**_Type 1: One management domain controlling a single instance_**

More complex operational environments may deploy EDC components as separate clustered instances under the operational control of a single management domain. For example, a Kubernetes cluster could be deployed with separate _ReplicateSets_ running pods of catalog servers, control planes, and data planes:

![](https://eclipse-edc.github.io/documentation/for-adopters/distributions-deployment-operations/cluster.svg)

**_Type 1: One management domain controlling a cluster of individual ReplicaSets_**

### Type 2: Distributed Management Domains[](#type-2-distributed-management-domains)
...
#### Type 2A: DSP Catalog Referencing EDC Stacks[](#type-2a-dsp-catalog-referencing-edc-stacks)
...
![](https://eclipse-edc.github.io/documentation/for-adopters/distributions-deployment-operations/distributed-type2a.svg)
...
#### Type 2B: EDC Catalog Server and Control/Data Plane Runtimes[](#type-2b-edc-catalog-server-and-controldata-plane-runtimes)
...
![](https://eclipse-edc.github.io/documentation/for-adopters/distributions-deployment-operations/distributed-type2b.svg)

**_Type 2B: Distributed Management Domains containing a Catalog Server and separate Control/Data Plane runtimes_**

#### Type 2C: Catalog Server/Control Plane with Data Plane Runtime[](#type-2c-catalog-servercontrol-plane-with-data-plane-runtime)

Or, Foo Industries could elect to run a centralized catalog server/control plane:

![](https://eclipse-edc.github.io/documentation/for-adopters/distributions-deployment-operations/distributed-type2c.svg)
...
### Setting Up Management Domains[](#setting-up-management-domains)
...
#### Configuring Linked Catalogs[](#configuring-linked-catalogs)
...
#### Management Domain Considerations[](#management-domain-considerations)
...
### Component High Availability[](#component-high-availability)
